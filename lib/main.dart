import 'package:cross_mate/ui/box_widget.dart';
import 'package:cross_mate/ui/camera_view.dart';
...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: RunModelByCamera(),
    );
  }
}

/// [RunModelByCamera] stacks [CameraView] and [BoxWidget]s with bottom sheet for stats
class RunModelByCamera extends StatefulWidget {
  const RunModelByCamera({super.key});

  @override
  RunModelByCameraState createState() => RunModelByCameraState();
}
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              if (classification != null) StatsRow('Classification:', '$classification'),
